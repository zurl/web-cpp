...
export class WReturn extends WStatement {
    ...
    public emitJSON(e: JSONEmitter): void {
        ...
        e.emitIns([Control.return, 0, this.getStartLine(e)]);
    }
...
export class WSetLocal extends WStatement {
    ...
    public emitJSON(e: JSONEmitter): void {
        this.value.emitJSON(e);
        e.emitIns([Control.set_local, this.offset, this.getStartLine(e)]);
    }
...
export class WSetGlobal extends WStatement {
    ...
    public emitJSON(e: JSONEmitter): void {
        ...
        this.value.emitJSON(e);
        e.emitIns([Control.set_global, e.getGlobalIdx(this.name), this.getStartLine(e)]);
    }
...
export class WDrop extends WStatement {
    ...
    public emitJSON(e: JSONEmitter): void {
        this.value.emitJSON(e);
        e.emitIns([Control.drop, 0, this.getStartLine(e)]);
    }
...
export class WBr extends WStatement {
    ...
    public emitJSON(e: JSONEmitter): void {
        e.emitIns([Control.br, this.labelIdx, this.getStartLine(e)]);
    }
...
export class WBrIf extends WStatement {
    ...
    public emitJSON(e: JSONEmitter): void {
        ...
        e.emitIns([Control.br_if, this.labelIdx, this.getStartLine(e)]);
    }
...
export class WIfElseBlock extends WStatement {
    ...
    public emitJSON(e: JSONEmitter): void {
        ...
        e.emitIns([Control.if, 0, this.getStartLine(e)]);
        ...
        e.emitIns([Control.end, 0, this.getStartLine(e)]);
    }
...
export class WBlock extends WStatement {
    ...
    public emitJSON(e: JSONEmitter): void {
        e.emitIns([Control.block, 0, this.getStartLine(e)]);
...
export class WLoop extends WStatement {
    ...
    public emitJSON(e: JSONEmitter): void {
        e.emitIns([Control.loop, 0, this.getStartLine(e)]);
        this.body.map((stmt) => stmt.emitJSON(e));
        e.emitIns([Control.end, 0, this.getStartLine(e)]);
    }
