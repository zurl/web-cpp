...
StructDeclaration=id:TypedefName _ '(' _ param:ParameterList?_ ')' _ initList:ConstructorInitializeList?_ body:CompoundStatement{ return new AST.ConstructorOrDestructorDeclaration(getLocation(),true,id,param,initList ||[],body);}/id:TypedefName _ '(' _ param:ParameterList?_ ')' _ initList:ConstructorInitializeList?_ ';'{ return new AST.ConstructorOrDestructorDeclaration(getLocation(),true,id,param,initList ||[],null);}/'~' id:TypedefName _ '(' _ ')' _ body:CompoundStatement{ return new AST.ConstructorOrDestructorDeclaration(getLocation(),false,id,null,null,body);}/'~' id:TypedefName _ '(' _ ')' _ ';'{ return new AST.ConstructorOrDestructorDeclaration(getLocation(),false,id,null,null,null);}/label:AccessControlKey _ ':'{ return new AST.AccessControlLabel(getLocation(),label);}/decl:ExternalDeclaration{ return decl;}
